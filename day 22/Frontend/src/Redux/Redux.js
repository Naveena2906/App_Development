    ...
    initialState,reducers:{
        ...
        addOrder:(state,action)=>{
          ...
          reduceProductQuantity: (state, action) => {
            const { productId, quantityToReduce } = action.payload;
...
export const{setadmin,addsign,addlogin,addproduct,removeproduct,updateproduct,setToUpdate,removeToUpdate,addtocart,removefromcart,increasequantity,decreasequantity,addOrder,removeAllFromCart,reduceProductQuantity}=Redux.actions;
