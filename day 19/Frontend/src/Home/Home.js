  ...
  return (
    <div className='landing-page' >
      <div className='lands'>
       ...
       <div className='land' style={{marginTop:"7%",marginRight:"40%",marginLeft:"4%",width:"40%"}}><h1 style={{fontSize:"290%"}}>Inventory Management System</h1></div>
      ...
      <div className='image1' style={{marginTop:"-20%",marginLeft:"40%"}}><img src='https://logixgrid.com/wp-content/uploads/2020/02/Cover-1-1-1536x1065.png' style={{width:"60%",height:"60vh"}}alt='Image'/></div>
      <div className='box' onClick={get} style={{marginTop:"-5%"}}>Get Started</div>
