  ...
  return (
    <div className='landing-page' >
      <div className='lands'>
       ...
       <div className='land' style={{marginTop:"7%",marginRight:"40%",marginLeft:"4%",width:"40%"}}><h1>Inventory Management System</h1></div>
      <div className='land' style={{marginTop:"1%",marginRight:"50%",marginLeft:"4%",width:"40%"}}><h4>By the Wholesalers,For the Wholesalers</h4></div>
